...
<head>
    ...
    <meta content="CRM, CMS болон бусад системүүдийг баруун талын админ тема болгон ашиглах боломжтой." name="description" />
                ...
                <div class="account-box">
                    ...
                    <div class="card-box p-5">
                        ...
                        <div class="text-center m-b-20">
                            ...
                            <h4>Өөрчлөлттэй болохыг үзээрэй!</h4>

                            <p class="text-muted font-14 m-t-10"> Та одоо амжилттай гарсан байна. <a href="../login.php" class="text-dark m-r-5"><b>Нэвтрэх</b></a> хуудас руу буцах</p>
                        </div>
