...
if(isset($_POST['submit'])){
	...
	if(!empty($title) && !empty($some_text)){
		...
		if($service_update){
			$_SESSION['service_update'] = "Амжилттай шинэчлэгдлээ!";
...
?>
	<div class="card text-dark mb-3" >
	  <div class="card-header bg-success text-center display-4">Үйлчилгээ шинэчлэх</div>
	  	<div class="card-body">

						<form action="" method="post" >

							<div class="form-group">
								<label for="project_name">Үйлчилгээний тэмдэг</label>
